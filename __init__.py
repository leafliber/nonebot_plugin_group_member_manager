...
check_inactive = on_command("gmm查看不活跃成员", permission=SUPERUSER, priority=5)
add_whitelist = on_command("gmm设定白名单", permission=SUPERUSER, priority=5)
remove_inactive = on_command("gmm删除不活跃成员", permission=SUPERUSER, priority=5)
